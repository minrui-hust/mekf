#pragma once
#include <Eigen/Core>
#include "manif/external/tl/tl/optional.hpp"
...
template <size_t _dim>
using Vectord = Vector<double, _dim>;
...
template <size_t _dim>
using SquareMatrixf = SquareMatrix<float, _dim>;

template <size_t _dim>
using SquareMatrixd = SquareMatrix<double, _dim>;
